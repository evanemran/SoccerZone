...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<FixturesResponse> getFixturesById(appid, apikey, id, page) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _headers = <String, dynamic>{
      r'X-RapidAPI-Host': appid,
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<FixturesResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'v2/seasons/${id}/fixtures',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = FixturesResponse.fromJson(_result.data!);
    return value;
  }
